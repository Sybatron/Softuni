    ...
    public partial class QuizGame : Form
    {
        ...
        void Check(Button btn)
        {
            ...
            switch (QuestiontextBox.Text)
            {
                ...
                case "Кой актьор играе ролята на Кевин Маккалистър във филма \"Сам вкъши\" 1 и \"Сам вкъши\" 2?":
                case "Коя от следните игри НЕ се игае с карти?":
                ...
                case "Кой от изброените няма обшо със семейството на Тодор Живков?":
        ...
        void NextQuestion(int num)
        {
            ...
            switch (num)
            {
                ...
                case 7:
                    ...
                    {
                        case 1:
                            QuestiontextBox.Text = "Кой от изброените няма обшо със семейството на Тодор Живков?";
                ...
                case 8:
                    ...
                    {
                        case 1:
                            QuestiontextBox.Text = "Коя от следните игри НЕ се игае с карти?";
