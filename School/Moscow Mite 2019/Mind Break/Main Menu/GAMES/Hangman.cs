...
namespace Hangman
{
    public partial class Hangman : Form
    {
        ...
        private void SubmitLetterButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Можете да въвеждате само букви на български", "Грешка!",
            ...
            {
                MessageBox.Show("Буквата, която въведохте, я няма в думата", "Извинете!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void SubmitWordButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!char.IsLetter(WordTextBox.Text[i]) || (WordTextBox.Text[i] >= '\u0061' && WordTextBox.Text[i] <= '\u007a'))
                {
                    MessageBox.Show("Можете да въвеждате само букви на български", "Грешка!",
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
            ...
            {
                MessageBox.Show("Думата, която въведохте не е исканата", "Извинете!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                DrawBodyPart((BodyParts)wrongCounter);
                EndOfGame(wrongCounter);
                wrongCounter++;
                WordTextBox.Text = "";
