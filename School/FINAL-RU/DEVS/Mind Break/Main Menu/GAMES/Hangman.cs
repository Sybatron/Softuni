...
namespace Hangman
{
    public partial class Hangman : Form
    {
        ...
        private void SubmitLetterButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Вводите буквы только на  кириллице", "Ошибка!",
            ...
            {
                MessageBox.Show("В слове нет этой буквы", "Извините!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void SubmitWordButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Слово, которое вы ввели не запрашивается", "Извините!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                DrawBodyPart((BodyParts)wrongCounter);
                EndOfGame(wrongCounter);
                wrongCounter++;
                WordTextBox.Text = "";
        ...
        void EndOfGame(int counter)
        {
            if (counter == 8)
            {
                MessageBox.Show("Проигрыш!\nСлово: " + word.ToString(), "Конец игры!",
