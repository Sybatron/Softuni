...
namespace PoinInFigureWindowsForm
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        private void Draw()
        {
            ...
            /* Calculate the scale factor (ratio) for the diagram holding the rectangle
            FormPointAndRectangle point in order to fi them well in the picture box */
            ...
            using (var g = Graphics.FromImage(pictureBox.Image))
            {
                ...
                //Draw point (scalled to the picture box size)
        ...
        private decimal Min(decimal a, decimal b, decimal c)
        {
            return Math.Min(a, Math.Min(b, c));
        }
        private decimal Max(decimal a, decimal b, decimal c)
        {
